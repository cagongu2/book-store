...
const createBookSchema = z.object({
    body: z.object({
        ...
        category: z.string({ required_error: "Danh mục là bắt buộc" }).regex(objectIdRegex, "ID danh mục không hợp lệ"),
        categories: z.array(z.string().regex(objectIdRegex, "ID danh mục phụ không hợp lệ")).optional(),
